	...
	def StoreData(self):
		...
		if self.Ultimaker2Radio.GetValue() or self.Ultimaker2GoRadio.GetValue() or self.Ultimaker2ExtRadio.GetValue():
			...
			if self.LulzbotTaz4Radio.GetValue():
				...
				profile.putMachineSetting('extruder_head_size_min_x', '47')
				profile.putMachineSetting('extruder_head_size_min_y', '22')
				profile.putMachineSetting('extruder_head_size_max_x', '77')
				profile.putMachineSetting('extruder_head_size_max_y', '40')
				profile.putMachineSetting('extruder_head_size_height', '38')
